...
const defaultSecuritySettings: SecuritySettings = {
  ...
  AccountFiveHourRateLimitEnabled: false,
  AccountFiveHourRateLimitCount: 0,
  AccountFiveHourRateLimitSuccessCount: 0,
  AccountFiveHourRateLimitGroup: '',
  AccountWeeklyRateLimitEnabled: false,
  AccountWeeklyRateLimitCount: 0,
  AccountWeeklyRateLimitSuccessCount: 0,
